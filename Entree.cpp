...
void moteur (int numPorte)
{
	...
	if (msg !=-1)
	{
		...
		requeteCourante.barriere = numPorte;
		...
		//Le PK est plein
		{
			Afficher(MESSAGE,"Et bim! Parking plein");
